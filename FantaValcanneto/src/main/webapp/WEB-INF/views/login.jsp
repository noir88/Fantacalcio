...
<form class="form-horizontal col-lg-offset-6 col-lg-6" style="margin-top: 15%" action="login" method="post" >
  ...
  <fieldset>
    ...
    <div class="form-group">
      <div class="col-lg-10 col-lg-offset-2">
       ...
       <h6 style="display:inline"><a href="FormRegistrazione">Oppure registrati qui.</a></h6>
